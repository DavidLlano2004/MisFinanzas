...
Abrir `app/src/main/res/layout/activity_main.xml` y reemplazar todo el contenido:
...
Abrir `app/src/main/java/com/ejemplo/misfinanzas/MainActivity.kt` y reemplazar todo:
...
Es momento de ver nuestra app funcionando:
...
- SDK no encontrado → revisar [Capítulo 0](00_configuracion_entorno.md)
...
|---------|--------|-----------|
| `app/build.gradle.kts` | Modificado | Activar viewBinding |
| `activity_main.xml` | Modificado | Layout con dos TextViews |
| `MainActivity.kt` | Modificado | Código que modifica los textos |

---

**Anterior:** [← Capítulo 0 — Configuración del entorno](00_configuracion_entorno.md) | **Siguiente:** [Capítulo 2 — Kotlin básico →](02_kotlin_basico.md)
